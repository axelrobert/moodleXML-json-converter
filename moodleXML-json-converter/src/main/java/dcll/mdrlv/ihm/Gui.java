...
public class Gui extends javax.swing.JFrame {
	...
	private void jButtonValiderActionPerformed(
		...
		case INIT_JSON_XML:
			if (jTextFieldPathIN.getText().equals("")) {
				JOptionPane.showMessageDialog(this, "Veuillez " + "renseigner "
						+ "un chemin pour" + " le fichier à " + "convertir");
			} else {
				...
				.setText(getEmplacementFile(jTextFieldPathIN.getText()));
		...
		case INIT_XML_JSON:
			if (jTextFieldPathIN.getText().equals("")) {
				...
				jTextFieldPathOut.setText(getEmplacementFile(jTextFieldPathIN
						.getText()));
		...
		case OUTPUT_JSON_XML:
			throw new RuntimeException("Bouton Valider : "
					+ "action interdite car Etat OUTPUT_JSON_XML");
		case OUTPUT_XML_JSON:
			throw new RuntimeException("Bouton Valider : "
					+ "action interdite car Etat OUTPUT_XML_JSON");
		case VIEW_JSON_XML:
			throw new RuntimeException("Bouton Valider :"
					+ " action interdite car Etat VIEW_JSON_XML");
		case VIEW_XML_JSON:
			throw new RuntimeException("Bouton Valider :"
					+ " action interdite car Etat VIEW_XML_JSON");
	...
	private void jButtonConvertirActionPerformed(
		...
		case INIT_JSON_XML:
			throw new RuntimeException("Bouton Convertir : "
					+ "action interdite car Etat INIT_JSON_XML");
		case INIT_XML_JSON:
			throw new RuntimeException("Bouton Convertir :"
		...
		case OUTPUT_JSON_XML:
			if (jTextFieldPathOut.getText().equals("")) {
				JOptionPane.showMessageDialog(this, "Veuillez renseigner"
						+ " un chemin pour le " + "fichier en sortie");
			} else {
				...
				try {
					if (xmlConverter.fileValidation(new File(fichierIN)) == FileConformity.OK) {
						...
						LOGGER.info("Fin de la conversion :"
						...
						LOGGER.warn("Le ficher n'est"
								+ " pas valide, conversion" + " annulée.");
						JOptionPane.showMessageDialog(this, "Le ficher n'est"
								+ " pas valide, conversion" + " annulée.");
						etat = Etat.INIT_XML_JSON;
						gestionEtat(etat);
					...
					JOptionPane.showMessageDialog(this,
							"Problème de création du fichier,"
			...
			if (jTextFieldPathOut.getText().equals("")) {
				...
				try {
					if (xmlConverter.fileValidation(new File(fichierIN)) == FileConformity.OK) {
						...
						FileConformity result = xmlConverter
								.fileValidation(new File(fichierIN));
						switch (result) {
	 ...
	 *             :
	 */
	public final void afficherTextArea(final JTextArea txt, final String file)
			throws FileNotFoundException {
